    ...
    <div className="flex min-h-screen bg-[#0b0b0b] text-white">
      ...
      <aside className="w-64 bg-[#0f0f0f] border-r border-[#222] p-6 flex flex-col">
        ...
        <nav className="flex-1 space-y-4">
          <Link
            href="/"
            className="block px-3 py-2 mt-3 rounded bg-[#1a1a1a] text-md font-semibold"
          >
            Dashboard
          </Link>
          <Link
            href="/videos/create"
            className="block px-3 py-2 mt-2 rounded  text-md font-semibold  bg-red-500 hover:bg-red-700 transition"
          >
            + New Video
          </Link>
        </nav>
